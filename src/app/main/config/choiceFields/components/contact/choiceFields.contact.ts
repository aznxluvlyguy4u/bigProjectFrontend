...
@Component({
    selector: 'choicefields-contact',
    directives: [REACTIVE_FORM_DIRECTIVES],
    templateUrl: '/app/main/config/choiceFields/components/contact/choiceFields.contact.html',
    pipes: [TranslatePipe]
})

export class ChoiceFieldsContactComponent {
