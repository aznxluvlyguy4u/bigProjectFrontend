...
@Component({
    selector: 'choicefields-depart',
    directives: [REACTIVE_FORM_DIRECTIVES],
    templateUrl: '/app/main/config/choiceFields/components/depart/choiceFields.depart.html',
    pipes: [TranslatePipe]
})

export class ChoiceFieldsDepartComponent {
